# The following code could use a bit of object oriented artistry. While its a simple method and works just fine as it is,
...
class Person  
 ...
 def greet(your_name)
  return "Hello #{your_name}, my name is #{@name}"
 end
